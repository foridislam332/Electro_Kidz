            ...
            <section className='py-12'>
                <div className="container">
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-10 w-full'>
                        <div data-aos="fade-right" className='shadow-xl p-4 rounded-lg hover:shadow-lightBlue transition-all duration-300 ease-in-out'>
                        ...
                        <div data-aos="fade-left" className='shadow-xl p-4 rounded-lg hover:shadow-lightBlue transition-all duration-300 ease-in-out'>
