...
const GalleryCard = ({ toy }) => {
    ...
    return (
        <div data-aos="fade-up" className="h-64 w-80 md:w-full mx-auto bg-white p-14 md:flex flex-col relative hover:scale-110 border border-blue hover:border-pink z-10 hover:z-40 transition-all duration-300 ease-in-out group">
